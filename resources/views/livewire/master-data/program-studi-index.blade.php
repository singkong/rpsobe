<x-layouts.app title="Data Program Studi">
    <div class="card">
        ...
        <div class="card-body border-bottom py-3">
            <div class="d-flex gap-2">
                <select wire:model.live="filterFakultasId" class="form-select w-auto">
                    ...
                    @foreach($this->fakultasOptions() as $f)
                    ...
                    <form wire:submit="save">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select wire:model="fakultas_id" class="form-select @error('fakultas_id') is-invalid @enderror">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nama Program Studi">
                                @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="mb-3">
                                <label class="form-label required">Kode</label>
                                <input type="text" wire:model="code" class="form-control @error('code') is-invalid @enderror" placeholder="Kode Prodi">
                                @error('code') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="mb-3">
                                <label class="form-label required">Jenjang</label>
                                <select wire:model="jenjang" class="form-select @error('jenjang') is-invalid @enderror">
                                    <option value="">Pilih Jenjang</option>
                                    @foreach($this->jenjangOptions() as $j)
