<div class="nav-item dropdown">
    <a href="#" class="nav-link px-2" data-bs-toggle="dropdown" aria-label="Notifikasi">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unreadCount > 0): ?>
            <span class="badge bg-red"><?php echo e($unreadCount); ?></span>
    ...
    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow dropdown-menu-card">
        <div class="card">
            ...
            <div class="list-group list-group-flush">
                <a href="<?php echo e(route('notifications.index')); ?>" class="list-group-item text-center text-primary">
                    Lihat Semua Notifikasi
                </a>
            </div>
        </div>
    </div>
</div><?php /**PATH E:\laragon\www\rps-obe\storage\framework\views/57f354495f85f3946e6ecfe20949d74f.blade.php ENDPATH**/ ?>