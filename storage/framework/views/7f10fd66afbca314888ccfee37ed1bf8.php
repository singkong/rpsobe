        ...
        <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <span class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-reset text-decoration-none"><strong>RPS</strong> OBE</a>
                </span>
                <div class="collapse navbar-collapse" id="sidebar-menu">
                    <ul class="navbar-nav pt-lg-3">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle collapsed" href="#sidebar-admin" data-bs-toggle="collapse" data-bs-auto-close="false" role="button" aria-expanded="<?php echo e(request()->routeIs('tenants.*') ? 'true' : 'false'); ?>">
                            ...
                            <div class="collapse <?php echo e(request()->routeIs('tenants.*') ? 'show' : ''); ?>" id="sidebar-admin" data-bs-parent="#sidebar-menu">
                                <ul class="navbar-nav ps-3">
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('tenants.*') ? 'active' : ''); ?>" href="<?php echo e(route('tenants.index')); ?>">Manajemen Tenant</a></li>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole(['super-admin','admin-univ','admin-fakultas','admin-prodi','kaprodi'])): ?>
                        <li class="nav-item">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole(['super-admin','admin-univ','kaprodi'])): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('templates.*') ? 'active' : ''); ?>" href="<?php echo e(route('templates.index')); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole(['super-admin','admin-univ','admin-fakultas','admin-prodi','kaprodi'])): ?>
                        <li class="nav-item dropdown <?php echo e(request()->routeIs('master-data.*') ? 'show' : ''); ?>">
                            <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('master-data.*') ? '' : 'collapsed'); ?>" href="#sidebar-masterdata" data-bs-toggle="collapse" data-bs-auto-close="false" role="button" aria-expanded="<?php echo e(request()->routeIs('master-data.*') ? 'true' : 'false'); ?>">
                            ...
                            <div class="collapse <?php echo e(request()->routeIs('master-data.*') ? 'show' : ''); ?>" id="sidebar-masterdata" data-bs-parent="#sidebar-menu">
                                <ul class="navbar-nav ps-3">
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('master-data.fakultas') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.fakultas')); ?>">Fakultas</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('master-data.program-studi') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.program-studi')); ?>">Program Studi</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('master-data.kurikulum') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.kurikulum')); ?>">Kurikulum</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('master-data.mata-kuliah') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.mata-kuliah')); ?>">Mata Kuliah</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('master-data.dosen') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.dosen')); ?>">Dosen</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('master-data.cpl') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.cpl')); ?>">CPL</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('master-data.profil-lulusan') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.profil-lulusan')); ?>">Profil Lulusan</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('master-data.semester') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.semester')); ?>">Semester</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('master-data.referensi') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.referensi')); ?>">Referensi</a></li>
                                </ul>
                            </div>
                        </li>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole(['super-admin','admin-univ','admin-fakultas','admin-prodi','kaprodi','dosen'])): ?>
                        <li class="nav-item dropdown <?php echo e(request()->routeIs('rps.*') ? 'show' : ''); ?>">
                            <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('rps.*') ? '' : 'collapsed'); ?>" href="#sidebar-rps" data-bs-toggle="collapse" data-bs-auto-close="false" role="button" aria-expanded="<?php echo e(request()->routeIs('rps.*') ? 'true' : 'false'); ?>">
                            ...
                            <div class="collapse <?php echo e(request()->routeIs('rps.*') ? 'show' : ''); ?>" id="sidebar-rps" data-bs-parent="#sidebar-menu">
                                <ul class="navbar-nav ps-3">
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('rps.index') ? 'active' : ''); ?>" href="<?php echo e(route('rps.index')); ?>">Daftar RPS</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('rps.create') ? 'active' : ''); ?>" href="<?php echo e(route('rps.create')); ?>">Buat RPS Baru</a></li>
                                </ul>
                            </div>
                        </li>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole(['super-admin','reviewer','kaprodi'])): ?>
                        <li class="nav-item">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole(['super-admin','kaprodi'])): ?>
                        <li class="nav-item">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole(['super-admin','admin-univ','lpm'])): ?>
                        <li class="nav-item">
...
?>
<?php echo e($roleLabels[auth()->user()->roles->first()->name ?? 'dosen'] ?? 'User'); ?></div>
                            </div>
                        </a>
