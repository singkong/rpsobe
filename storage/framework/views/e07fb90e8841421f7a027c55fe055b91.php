    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-actions">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('program-studi.create')): ?>
        ...
        <div class="card-body border-bottom py-3">
            <div class="d-flex gap-2">
                <select wire:model.live="filterFakultasId" class="form-select w-auto">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->fakultasOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter card-table table-striped">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->prodiList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($item->name); ?></td>
                            <td><span class="badge bg-primary-lt"><?php echo e($item->code); ?></span></td>
                            <td><?php echo e($item->fakultas?->name ?? '-'); ?></td>
                            <td><span class="badge bg-azure-lt"><?php echo e($item->jenjang?->label() ?? $item->jenjang); ?></span></td>
                            <td><?php echo e($item->akreditasi ?? '-'); ?></td>
                            <td><?php echo e($item->kaprodi_name ?? '-'); ?></td>
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('program-studi.update')): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('program-studi.delete')): ?>
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary">Menampilkan <?php echo e($this->prodiList()->firstItem()); ?> - <?php echo e($this->prodiList()->lastItem()); ?> dari <?php echo e($this->prodiList()->total()); ?></p>
            <div class="ms-auto"><?php echo e($this->prodiList()->links()); ?></div>
        </div>
    </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e($editId ? 'Edit' : 'Tambah'); ?> Program Studi</h5>
                    ...
                    <form wire:submit="save">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select wire:model="fakultas_id" class="form-select <?php $__errorArgs = ['fakultas_id'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Nama Program Studi">
...
unset($__errorArgs, $__bag); ?>" placeholder="Kode Prodi">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select wire:model="jenjang" class="form-select <?php $__errorArgs = ['jenjang'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->jenjangOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH E:\laragon\www\rps-obe\resources\views/livewire/master-data/program-studi-index.blade.php ENDPATH**/ ?>