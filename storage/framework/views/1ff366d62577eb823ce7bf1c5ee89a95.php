        ...
        <div class="row mb-3">
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2">
                <div class="card">
                    <div class="card-body p-3 text-center">
                        <div class="h1 m-0"><?php echo e($this->stats()['totalTenants']); ?></div>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2">
                <div class="card">
                    ...
                    <div class="card-body p-3 text-center">
                        <div class="h1 m-0"><?php echo e($this->stats()['activeTenants']); ?></div>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2">
                <div class="card">
                    ...
                    <div class="card-body p-3 text-center">
                        <div class="h1 m-0"><?php echo e($this->stats()['inactiveTenants']); ?></div>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2">
                <div class="card">
                    <div class="card-body p-3 text-center">
                        <div class="h1 m-0"><?php echo e($this->stats()['totalUsers']); ?></div>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2">
                <div class="card">
                    <div class="card-body p-3 text-center">
                        <div class="h1 m-0"><?php echo e($this->stats()['totalRps']); ?></div>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2">
                <div class="card">
                    <div class="card-body p-3 text-center">
                        <div class="h1 m-0"><?php echo e($this->stats()['totalPublished']); ?></div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span class="badge bg-green-lt"><?php echo e($this->stats()['activeTenants']); ?>/<?php echo e($this->stats()['totalTenants']); ?></span>
                        </div>
                        <div class="d-flex align-items-center">
                            <small class="text-secondary flex-grow-1">Total Users</small>
                            <span class="fw-bold"><?php echo e($this->stats()['totalUsers']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span class="fw-bold"><?php echo e($this->stats()['totalRps']); ?></span>
                        </div>
                        <div class="d-flex align-items-center">
                            <small class="text-secondary flex-grow-1">Published</small>
                            <span class="fw-bold"><?php echo e($this->stats()['totalPublished']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('reports.index')); ?>" class="btn btn-sm btn-outline-primary">Reports</a>
                            <a href="<?php echo e(route('master-data.dashboard')); ?>" class="btn btn-sm btn-outline-azure">Master Data</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->recentTenants(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="fw-bold"><?php echo e($tenant['name']); ?></td>
                                    <td class="text-secondary"><?php echo e($tenant['code']); ?></td>
                                    <td>
                                        <span class="badge <?php echo e($tenant['is_active'] ? 'bg-green-lt' : 'bg-red-lt'); ?>">
                                    ...
                                    <td class="text-secondary small"><?php echo e(\Carbon\Carbon::parse($tenant['updated_at'])->diffForHumans()); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($this->recentTenants())): ?>
                                <tr>
