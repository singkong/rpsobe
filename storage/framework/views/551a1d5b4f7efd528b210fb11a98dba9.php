    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-actions">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('profil-lulusan.create')): ?>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter card-table table-striped">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->profilList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($item->name); ?></td>
                            <td><?php echo e(\Illuminate\Support\Str::limit($item->deskripsi, 60)); ?></td>
                            <td><?php echo e($item->programStudi?->name ?? '-'); ?></td>
                            <td><span class="badge bg-blue-lt"><?php echo e($item->cpls->count()); ?> CPL</span></td>
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('profil-lulusan.update')): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('profil-lulusan.delete')): ?>
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary">Menampilkan <?php echo e($this->profilList()->firstItem()); ?> - <?php echo e($this->profilList()->lastItem()); ?> dari <?php echo e($this->profilList()->total()); ?></p>
            <div class="ms-auto"><?php echo e($this->profilList()->links()); ?></div>
        </div>
    </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e($editId ? 'Edit' : 'Tambah'); ?> Profil Lulusan</h5>
...
unset($__errorArgs, $__bag); ?>" placeholder="Nama Profil Lulusan">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->cplOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-6">
                                            <label class="form-check">
                                                <input type="checkbox" wire:model="selectedCpls" value="<?php echo e($cpl->id); ?>" class="form-check-input">
                                                <span class="form-check-label"><strong><?php echo e($cpl->code); ?></strong> - <?php echo e(\Illuminate\Support\Str::limit($cpl->deskripsi, 50)); ?></span>
                                            </label>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
...
<?php /**PATH E:\laragon\www\rps-obe\resources\views/livewire/master-data/profil-lulusan-index.blade.php ENDPATH**/ ?>