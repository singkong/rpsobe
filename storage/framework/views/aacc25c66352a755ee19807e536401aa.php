    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-actions">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mata-kuliah.create')): ?>
        ...
        <div class="card-body border-bottom py-3">
            <div class="d-flex">
                <div class="text-secondary">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mata-kuliah.delete')): ?>
                        <button wire:click="bulkDelete" class="btn btn-outline-danger btn-sm" <?php if(count($selectedItems) === 0): ?> disabled <?php endif; ?>>
                            Hapus Terpilih (<?php echo e(count($selectedItems)); ?>)
                        </button>
                    <?php endif; ?>
                </div>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter card-table table-striped">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->mataKuliahList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><input type="checkbox" class="form-check-input" wire:model.live="selectedItems" value="<?php echo e($item->id); ?>"></td>
                            ...
                            <td><span class="badge <?php echo e($item->jenis === 'wajib' ? 'bg-azure-lt' : 'bg-orange-lt'); ?>"><?php echo e($item->jenis === 'wajib' ? 'Wajib' : 'Pilihan'); ?></span></td>
                            <td><?php echo e($item->kurikulum?->name ?? '-'); ?></td>
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mata-kuliah.update')): ?>
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary">Menampilkan <?php echo e($this->mataKuliahList()->firstItem()); ?> - <?php echo e($this->mataKuliahList()->lastItem()); ?> dari <?php echo e($this->mataKuliahList()->total()); ?></p>
            <div class="ms-auto"><?php echo e($this->mataKuliahList()->links()); ?></div>
        </div>
    </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e($editId ? 'Edit' : 'Tambah'); ?> Mata Kuliah</h5>
                    ...
                    <form wire:submit="save">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select wire:model="kurikulum_id" class="form-select <?php $__errorArgs = ['kurikulum_id'];
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->kurikulumOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Nama Mata Kuliah">
...
unset($__errorArgs, $__bag); ?>" placeholder="Kode MK">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" wire:model="sks" class="form-control <?php $__errorArgs = ['sks'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select wire:model="semester" class="form-select <?php $__errorArgs = ['semester'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['semester'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select wire:model="jenis" class="form-select <?php $__errorArgs = ['jenis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->jenisOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($j['value']); ?>"><?php echo e($j['label']); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <p class="text-secondary">Apakah Anda yakin ingin menghapus <?php echo e($showDeleteConfirm === 'bulk' ? count($selectedItems) . ' mata kuliah' : 'mata kuliah ini'); ?>?</p>
                    </div>
                    <div class="modal-footer">
                        <div class="w-100">
                            <div class="row">
...
<?php /**PATH E:\laragon\www\rps-obe\resources\views/livewire/master-data/mata-kuliah-index.blade.php ENDPATH**/ ?>