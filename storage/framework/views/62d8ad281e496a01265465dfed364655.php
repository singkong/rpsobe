    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-actions">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('referensi.create')): ?>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter card-table table-striped">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->referensiList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e(\Illuminate\Support\Str::limit($item->judul, 50)); ?></td>
                            <td><?php echo e($item->penulis ?? '-'); ?></td>
                            <td><?php echo e($item->tahun ?? '-'); ?></td>
                            <td><?php echo e($item->penerbit ?? '-'); ?></td>
                            <td>
                                <span class="badge <?php echo e(match($item->format) { 'buku' => 'bg-primary-lt', 'jurnal' => 'bg-azure-lt', 'artikel' => 'bg-green-lt', 'website' => 'bg-yellow-lt', default => 'bg-secondary-lt' }); ?>">
                                    <?php echo e(match($item->format) { 'buku' => 'Buku', 'jurnal' => 'Jurnal', 'artikel' => 'Artikel', 'website' => 'Website', default => 'Lainnya' }); ?>

                                </span>
                            </td>
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('referensi.update')): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('referensi.delete')): ?>
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary">Menampilkan <?php echo e($this->referensiList()->firstItem()); ?> - <?php echo e($this->referensiList()->lastItem()); ?> dari <?php echo e($this->referensiList()->total()); ?></p>
            <div class="ms-auto"><?php echo e($this->referensiList()->links()); ?></div>
        </div>
    </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e($editId ? 'Edit' : 'Tambah'); ?> Referensi</h5>
                    ...
                    <form wire:submit="save">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model="judul" class="form-control <?php $__errorArgs = ['judul'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Judul Referensi">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select wire:model="format" class="form-select <?php $__errorArgs = ['format'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->formatOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($f['value']); ?>"><?php echo e($f['label']); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['format'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
<?php /**PATH E:\laragon\www\rps-obe\resources\views/livewire/master-data/referensi-index.blade.php ENDPATH**/ ?>