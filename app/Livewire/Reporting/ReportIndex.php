...
<div>
    ...
    <?= -- Tab Content -- ?>
    <?php if($activeTab === 'completion' && $completionData)
        <div class="row mb-3">
            ...
            <?php $sd = $completionData['statusDistribution']; ?>
            <div class="col-lg-3 col-sm-6 mb-2">
                <div class="card">
                    <div class="card-body p-3 text-center">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                ?>
                <?php foreach($sd as $status => $count)
                    <?php
                        try {
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            <?php foreach($completionData['completionPerProdi'] as $prodi)
                                <?php $prodiPct = $prodi['total'] > 0 ? round(($prodi['published'] / $prodi['total']) * 100, 1) : 0; ?>
                                <tr>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            <?php foreach($completionData['detailList'] as $rps)
                                <tr>
                                    <td>
    ...
    <?php elseif($activeTab === 'quality' && $qualityData)
        <?= -- Quality Stats -- ?>
        <div class="row mb-3">
            <div class="col-lg-3 col-sm-6 mb-2">
                <div class="card">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <?php if(empty($qualityData['prodiAverages']))
                    <div class="text-center text-secondary py-4">Belum ada data review</div>
                <?php else: ?>
                    <?php $maxAvg = max(array_column($qualityData['prodiAverages'], 'avgScore')) ?: 1; ?>
                    <?php foreach($qualityData['prodiAverages'] as $pa)
                        <?php $barPct = ($pa['avgScore'] / $maxAvg) * 100; ?>
                        <div class="mb-3">
                            <div class="d-flex justify-content-between small mb-1">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            <?php foreach($qualityData['reviews'] as $review)
                                <tr>
                                    <td>
    ...
    <?php elseif($activeTab === 'comparison' && $comparisonData)
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <?php foreach($comparisonData['data1']['statusCounts'] as $status => $count)
                            <?php
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php foreach($comparisonData['data2']['statusCounts'] as $status => $count)
                            <?php
                                try { $label = \App\Enums\RPSStatus::from($status)->label(); }
                                catch (\Exception $e) { $label = $status; }
                            ?>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                ?>
                <?php foreach($comparisonData['data1']['byProdi'] as $index => $d1)
                    <?php
    ...
    <?php elseif($activeTab === 'audit' && $auditData)
        <div class="row mb-3">
            <div class="col-lg-3 col-sm-6 mb-2">
                <div class="card">
                    <div class="card-body p-3 text-center">
            ...
            <?php foreach($auditData['actionCounts'] as $action => $count)
            <div class="col-lg-3 col-sm-6 mb-2">
                <div class="card">
                    <div class="card-body p-3 text-center">
