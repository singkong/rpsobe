...
<div>
    ...
    <?php if($data)
        <div class="row mb-3">
            <?php $sd = $data['statusDistribution']; $totalRps = $data['totalRps'] ?: 1; ?>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <?php if(empty($data['completionPerProdi']))
                            <div class="text-center text-secondary py-4">Belum ada data</div>
                        <?php else: ?>
                            <?php $maxTotal = max(array_column($data['completionPerProdi'], 'total')) ?: 1; ?>
                            <?php foreach($data['completionPerProdi'] as $prodi)
                                <?php $barPct = ($prodi['total'] / $maxTotal) * 100; ?>
                                <div class="mb-2">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php $colors = ['draft' => '#f59f00', 'review' => '#206bc4', 'revision' => '#d63939', 'approved' => '#2fb344', 'published' => '#0ca678', 'archived' => '#616876']; ?>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            <?php foreach($data['detailList'] as $rps)
                                <tr>
