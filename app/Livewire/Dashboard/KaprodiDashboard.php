            ...
            <div class="col-lg-6">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <?php foreach($this->statusCounts as $status => $count): ?>
                            <?php
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
                            <table class="table table-vcenter card-table">
                                ...
                                <tbody>
                                    <?php foreach($this->dosenProgress as $dp): ?>
                                        <tr>
                                            <td>
                                    ...
                                    <?php endforeach; ?>
                                    <?php if(empty($this->dosenProgress)): ?>
                                        <tr>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                ...
                                <tbody>
                                    <?php foreach($this->rpsMenungguReview as $rps): ?>
                                        <tr>
                                            <td>
                                    ...
                                    <?php endforeach; ?>
                                    <?php if($this->rpsMenungguReview->isEmpty()): ?>
                                        <tr>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                ...
                                <tbody>
                                    <?php foreach($this->rpsMenungguApproval as $rps): ?>
                                        <tr>
                                            <td>
                                                <div class="fw-bold"><?= $rps->mataKuliah?->name ?? '-' ?></div>
                                                <div class="text-secondary small"><?= $rps->mataKuliah?->code ?? '' ?></div>
                                    ...
                                    <?php endforeach; ?>
                                    <?php if($this->rpsMenungguApproval->isEmpty()): ?>
                                        <tr>
