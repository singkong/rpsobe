    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-actions">
                <?php if(Gate::allows('profil-lulusan.create')): ?>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter card-table table-striped">
                ...
                <tbody>
                    <?php foreach($this->profilList() as $item): ?>
                        <tr>
                            <td><?= $item->name ?></td>
                            ...
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <?php if(Gate::allows('profil-lulusan.update')): ?>
                                    ...
                                    <?php if(Gate::allows('profil-lulusan.delete')): ?>
                    ...
                    <form wire:submit="save">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model="name" class="form-control : ?><div class="invalid-feedback"><?= (isset(`$errors) ? `$errors->first('name') ?></div> is-invalid " placeholder="Nama Profil Lulusan">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <?php foreach($this->cplOptions() as $cpl): ?>
                                        <div class="col-md-6">
