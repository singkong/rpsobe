        ...
        <div class="card-body border-bottom py-3">
            <div class="d-flex gap-2">
                ...
                <select wire:model.live="filterKategori" class="form-select w-auto">
                    ...
                    @foreach($this->kategoriOptions() as $k)
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" wire:model="code" class="form-control @error('code') is-invalid @enderror" placeholder="CPL-S1">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea wire:model="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3" placeholder="Deskripsi CPL"></textarea>
