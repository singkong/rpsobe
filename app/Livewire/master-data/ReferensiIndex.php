    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-actions">
                <?php if(Gate::allows('referensi.create')): ?>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter card-table table-striped">
                ...
                <tbody>
                    <?php foreach($this->referensiList(): ?> as $item)
                        <tr>
                            ...
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <?php if(Gate::allows('referensi.update')): ?>
                                    ...
                                    <?php if(Gate::allows('referensi.delete')): ?>
                    ...
                    <form wire:submit="save">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model="judul" class="form-control : ?><div class="invalid-feedback"><?= (isset(`$errors) ? `$errors->first('judul') ?></div> is-invalid " placeholder="Judul Referensi">
                                : ?><div class="invalid-feedback"><?= (isset(`$errors) ? `$errors->first('judul') ?></div>  
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select wire:model="format" class="form-select : ?><div class="invalid-feedback"><?= (isset(`$errors) ? `$errors->first('format') ?></div> is-invalid ">
                                        <option value="">Pilih Format</option>
                                        <?php foreach($this->formatOptions(): ?> as $f)
                                            <option value="<?= $f['value'] ?>"><?= $f['label'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    : ?><div class="invalid-feedback"><?= (isset(`$errors) ? `$errors->first('format') ?></div>  
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                : ?><div class="invalid-feedback"><?= (isset(`$errors) ? `$errors->first('url') ?></div>  
                            </div>
                        </div>
