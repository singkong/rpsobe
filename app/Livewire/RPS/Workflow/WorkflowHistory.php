            ...
            <div class="row">
                                            ...
                                            <li class="timeline-event">
                                                ...
                                                <div class="card timeline-event-card">
                                                    <div class="card-body">
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if(!empty($item['skor_per_komponen']))
                                                        <div class="mt-2">
                                                            <small class="text-secondary">Detail Skor:</small>
                                                            <div class="row g-1 mt-1">
                                                                <?php foreach($item['skor_per_komponen'] as $k => $v)
                                                                    <?php if($v)
                                                                    <div class="col-auto">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <?php foreach($item['komentar'] as $k => $kom)
                                                                <?php if($kom)
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <?php $versions = \App\Models\RPSVersion::with('createdBy')->where('rps_id', $rps->id)->orderBy('created_at', 'desc')->get(); ?>
                            <?php if($versions->isEmpty())
