            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-vcenter card-table table-striped">
                        ...
                        <tbody>
                            <?php $list = $this->approvalList(); ?>
                            <?php foreach($list as $rps)
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php if($rps->reviews->isNotEmpty())
                                            <?php foreach($rps->reviews->take(2) as $review)
                                    ...
                                    <td>
                                        <div class="btn-list flex-nowrap">
                                            <?php if($rps->status === \App\Enums\RPSStatus::Review)
                                            ...
                                            <?php elseif($rps->status === \App\Enums\RPSStatus::Approved)
