    ...
    <div class="card">
            ...
            <div class="row g-2">
                ...
                <div class="col-md-2">
                    <select wire:model.live="filterStatus" class="form-select">
                        ...
                        <?php foreach(App\Enums\RPSStatus::cases() as $status): ?>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter card-table table-striped">
                <thead>
                    <tr>
                        <th wire:click="sortBy('mata_kuliah_id')" style="cursor:pointer">Mata Kuliah <?php if($sortField === 'mata_kuliah_id'): ?><?= $sortDirection === 'asc' ? '&#9650;' : '&#9660;' ?><?php endif; ?></th>
                        <th>Semester</th>
                        <th>Status</th>
                ...
                <tbody>
                    <?php foreach($this->rpsList() as $item): ?>
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <?php if($item->isEditable() || ($item->user_id === Auth::id())): ?>
