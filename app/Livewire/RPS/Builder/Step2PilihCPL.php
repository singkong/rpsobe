                                ...
                                <div class="card-body">
                                    <label class="form-check mb-0">
                                        <input type="checkbox" class="form-check-input"
                                               ...
                                               <?= in_array($cpl->id, $selectedCpl) ? 'checked' : '' ?>>
